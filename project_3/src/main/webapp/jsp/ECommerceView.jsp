<%@page import="in.co.rays.project_3.controller.ECommerceCtl"%>
...
<body class="p4">
	...
	<div>
		...
		<main>
		<form action="<%=ORSView.ECOMMERCE_CTL%>" method="post">
				...
				<div class="col-md-4 mb-4">
					<div class="card">
						<div class="card-body">
							...
							%>
							<h3 class="text-center text-primary">Update ECommerce</h3>
							<%
								} else {
							%>
							<h3 class="text-center text-primary">Add ECommerce</h3>
							<%
								}
							%>
							<!--Body-->
							...
							<div class="md-form">
								...
								<span class="pl-sm-5"><b>PaymenetStatus</b> <span
									style="color: red;">*</span></span></br>
								<div class="col-sm-12">
									<div class="input-group">
										<div class="input-group-prepend">
										...
										<input type="text" name="paymentStatus"
											class="form-control" placeholder="PaymentStatus"
											value="<%=DataUtility.getStringData(dto.getPaymentStatus())%>">
									</div>
								</div>
								<font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("paymentStatus", request)%></font></br>
							</div>
							</br>
							<%
								if (dto.getId() != null && dto.getId() > 0) {
							...
							<div class="text-center">
								...
								<input type="submit" name="operation"
									...
									value="<%=ECommerceCtl.OP_UPDATE%>"> <input type="submit"
									name="operation" class="btn btn-warning btn-md"
									style="font-size: 17px" value="<%=ECommerceCtl.OP_CANCEL%>">
							</div>
							<%
								} else {
							%>
							<div class="text-center">
								...
								<input type="submit" name="operation"
									class="btn btn-success btn-md" style="font-size: 17px"
									value="<%=ECommerceCtl.OP_SAVE%>"> <input type="submit"
									name="operation" class="btn btn-warning btn-md"
									style="font-size: 17px" value="<%=ECommerceCtl.OP_RESET%>">
							</div>
							<%
								}
							%>
