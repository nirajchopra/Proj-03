			...
			<div class="container">
				<div class="row justify-content-center mt-4">
					...
					<div class="col-12 col-sm-10 col-md-8 col-lg-6 col-xl-5">
						...
						<form action="<%=ORSView.PROFILE_CTL%>" method="post" class="w-100">
							...
							<div class="card grad-card shadow-sm">
                                ...
                                %>
									...
									<%
                                    HashMap<String, String> profileStatusMap =
                                        (HashMap<String, String>) request.getAttribute("profileStatusMap");
                                HashMap<String, String>	genderMap =
                                        (HashMap<String, String>) request.getAttribute("genderMap");
                                %>
									...
									<div class="form-group mb-3">
										...
										<small class="text-danger"> <%=ServletUtility.getErrorMessage("fullName", request)%>
										</small>
									</div>
									...
									<div class="form-group mb-3">
										...
										<small class="text-danger"> <%=ServletUtility.getErrorMessage("dob", request)%>
										</small>
									</div>
									
									<div class="form-group mb-3">
										<label><strong>Gender</strong> <span
											class="text-danger">*</span></label>
										<div class="input-group input-group-sm">
											<div class="input-group-prepend">
												<span class="input-group-text"><i
											...
											<%=HTMLUtility.getList("gender", dto.getGender(), genderMap)%>
										</div>
										<small class="text-danger"> <%=ServletUtility.getErrorMessage("gender", request)%>
										</small>
									</div>
									
									
									<div class="form-group mb-3">
										<label><strong>Profile Status</strong> <span
											class="text-danger">*</span></label>
										<div class="input-group input-group-sm">
											<div class="input-group-prepend">
												<span class="input-group-text"><i
											...
											<%=HTMLUtility.getList("profileStatus", dto.getProfileStatus(), profileStatusMap)%>
										</div>
										<small class="text-danger"> <%=ServletUtility.getErrorMessage("profileStatus", request)%>
										</small>
									</div>
