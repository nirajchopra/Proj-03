...
<body class="p4">
	...
	<div class="container-fluid">
		...
		<h2 class="text-center text-light font-weight-bold">Session List</h2>
		...
		<form action="<%=ORSView.SESSION_LIST_CTL%>" method="post">
			...
			<%
				...
				List<SessionDTO> list = (List<SessionDTO>) ServletUtility.getList(request);
					...
					<tr>
						<td>
							<div
								...
								<!-- Session Token -->
								<div class="mx-2">
									<label><b>Session Token :</b></label>
								</div>
								<div class="mx-2">
									<input type="text" class="form-control form-control-sm"
										name="sessionToken" placeholder="Enter Session Token"
								...
								<div class="mx-2">
									<input type="submit" class="btn btn-sm btn-primary"
										name="operation" value="<%=SessionListCtl.OP_SEARCH%>">
				...
				<table
					...
					<tbody>
						...
						<tr>
							...
							<td><%=dto.getSessionToken()%></td>

							<td class="text-capitalize"><%=dto.getUserName()%></td>

							<td><%=DataUtility.getDateString(dto.getLoginTime())%></td>

							<td><%=DataUtility.getDateString(dto.getLogoutTime())%></td>

							<td><%=dto.getSessionStatus()%></td>

							<td><a href="SessionCtl?id=<%=dto.getId()%>"
			...
			<table class="table w-100">
				<tr>
					...
					<td width="25%" class="text-center"><input type="submit"
						...
						value="<%=SessionListCtl.OP_NEW%>"></td>
