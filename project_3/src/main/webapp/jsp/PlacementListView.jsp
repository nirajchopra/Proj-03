...
<%@page import="in.co.rays.project_3.dto.PlacementDTO"%>
...
<body class="p4">
	...
	<div class="container-fluid">
		...
		<h2 class="text-center text-light font-weight-bold">Placement
			List</h2>
		...
		<form action="<%=ORSView.PLACEMENT_LIST_CTL%>" method="post">
			...
			<%
				...
				List<PlacementDTO> list = (List<PlacementDTO>) ServletUtility.getList(request);

				Iterator<PlacementDTO> it = list.iterator();
					...
					<tr>
						<td>
							<div
								...
								<!-- Placement Code -->
								<div class="mx-2">
									<label><b>Placement Code :</b></label>
								</div>
								<div class="mx-2">
									<input type="text" class="form-control form-control-sm"
										name="placementCode" placeholder="Enter Placement Code"
										value="<%=ServletUtility.getParameter("placementCode", request)%>">
								</div>
								...
								<div class="mx-2">
									<input type="submit" class="btn btn-sm btn-primary"
										name="operation" value="<%=PlacementListCtl.OP_SEARCH%>">

									<input type="submit"
										class="btn btn-sm btn-outline-secondary ml-1" name="operation"
										value="<%=PlacementListCtl.OP_RESET%>">
								</div>
				...
				<table
					...
					<tbody>
						...
						<tr>
							...
							<td><%=dto.getPlacementCode()%></td>

							<td class="text-capitalize"><%=dto.getStudentName()%></td>

							<td><%=dto.getCompanyName()%></td>

							<td><%=dto.getPlacementStatus()%></td>

							<td><a href="PlacementCtl?id=<%=dto.getId()%>"
			...
			<table class="table w-100">
				<tr>
					<td class="text-right"><input type="submit"
						...
						value="<%=PlacementListCtl.OP_BACK%>"></td>
				</tr>
			</table>
