						...
						<div class="card-body">
							...
							<div class="md-form">
								...
								<div class="col-sm-12">
									<div class="input-group">
										...
										<input type="text" name="bookName" class="form-control"
											id="defaultForm-email" placeholder="Enter Book"
											value="<%=DataUtility.getStringData(dto.getBookName())%>">
									</div>
								</div>
								<font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("bookName", request)%></font></br>



								<span class="pl-sm-5"><b>Book Price</b><span
									style="color: red;">*</span></span> </br>
								<div class="col-sm-12">
									<div class="input-group">
										<div class="input-group-prepend">
										...
										<input type="text" name="bookPrice" class="form-control"
											...
											value="<%=DataUtility.getStringData(dto.getBookPrice())%>">
									</div>
								</div>
								<font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("bookPrice", request)%></font></br>
								...
								<div class="col-sm-12">
									<div class="input-group">
										...
										<input type="text" name="libraryName" class="form-control"
											placeholder="Enter LibraryName"
											value="<%=DataUtility.getStringData(dto.getLibraryName())%>">
									</div>
								</div>
								<font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("libraryName", request)%></font></br>
							...
							<div class="text-center">
								...
								<input type="submit" name="operation"
									...
									value="<%=BookCtl.OP_UPDATE%>"> <input type="submit"
									name="operation" class="btn btn-warning btn-md"
									style="font-size: 17px" value="<%=BookCtl.OP_CANCEL%>">
							</div>
							<%
								} else {
							%>
							<div class="text-center">
								...
								<input type="submit" name="operation"
									class="btn btn-success btn-md" style="font-size: 17px"
									value="<%=BookCtl.OP_SAVE%>"> <input type="submit"
									name="operation" class="btn btn-warning btn-md"
									style="font-size: 17px" value="<%=BookCtl.OP_RESET%>">
							</div>
							<%
								}
							%>
