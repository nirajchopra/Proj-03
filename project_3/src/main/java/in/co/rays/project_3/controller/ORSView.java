...
public interface ORSView {
	...
	public String NETWORK_MONITOR_VIEW = PAGE_FOLDER +"/NetworkMonitorView.jsp";
	public String NETWORK_MONITOR_LIST_VIEW = PAGE_FOLDER + "/NetworkMonitorListView.jsp";
	public String NETWORK_MONITOR_CTL = APP_CONTEXT + "/ctl/NetworkMonitorCtl";
	public String NETWORK_MONITOR_LIST_CTL = APP_CONTEXT + "/ctl/NetworkMonitorListCtl";
	
	public String ECOMMERCE_VIEW = PAGE_FOLDER + "/ECommerce.jsp";
	public String ECOMMERCE_LIST_VIEW = PAGE_FOLDER + "/ECommerce.jsp";
