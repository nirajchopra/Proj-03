...
@WebServlet(name = "NetworkMonitorListCtl", urlPatterns = "/ctl/NetworkMonitorListCtl")
public class NetworkMonitorListCtl extends BaseCtl {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (OP_SEARCH.equalsIgnoreCase(op)) {
            ...
            ServletUtility.redirect(ORSView.NETWORK_MONITOR_CTL, request, response);
            return;

        } else if (OP_RESET.equalsIgnoreCase(op)) {
            ServletUtility.redirect(ORSView.NETWORK_MONITOR_LIST_CTL, request, response);
            return;
            ...
            if (ids != null) {
                ...
                for (String id : ids) {
                    NetworkMonitorDTO deleteDto = new NetworkMonitorDTO();
                ...
                ServletUtility.setSuccessMessage("NetworkMonitor Deleted Successfully", request);
    ...
    protected String getView() {
        return ORSView.NETWORK_MONITOR_LIST_VIEW;
    }
}